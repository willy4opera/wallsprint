 ...
 * @since 1.0.0
 */
class Bzotech_Logo_Global extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Logo (Global)', 'bw-printxtore' );
	}
	...
	public function get_widget_css_config( $widget_name ) { 
	    $file_content_css = get_template_directory() . '/assets/global/css/elementor/logo.css';
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'text',
				'options'   => [
					'text'		=> esc_html__( 'Text', 'bw-printxtore' ),
	...
	protected function render() {
		...
		echo bzotech_get_template_elementor_global('logo/logo','',$attr);
	}
