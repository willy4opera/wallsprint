...
$item_thumbnail_post= bzotech_get_option('item_thumbnail_post');
$size           = bzotech_get_option('post_grid_size');
$item_title_post           = bzotech_get_option('item_title_post');
$item_meta_post           = bzotech_get_option('item_meta_post');
$item_meta_select_post           = bzotech_get_option('item_meta_select_post');
$item_excerpt_post           = bzotech_get_option('item_excerpt_post');
$excerpt        = bzotech_get_option('post_grid_excerpt',80);
$item_button_post        = bzotech_get_option('item_button_post');
/*---------------*/
$item_thumbnail_post_list        = bzotech_get_option('item_thumbnail_post_list');
$size_list      = bzotech_get_option('post_list_size');
$item_title_post_list      = bzotech_get_option('item_title_post_list');
$item_meta_post_list      = bzotech_get_option('item_meta_post_list');
$item_meta_select_post_list      = bzotech_get_option('item_meta_select_post_list');
$item_excerpt_post_list      = bzotech_get_option('item_excerpt_post_list');
$excerpt_list        = bzotech_get_option('post_list_excerpt');
$item_button_post_list        = bzotech_get_option('item_button_post_list');
/*--------------------*/
...
$attr = array(
    'item_thumbnail'    =>$item_thumbnail_post,
    'size'              => $size,
    'item_title'        =>$item_title_post,
    'item_meta'         =>$item_meta_post,
    'item_meta_select'  =>$item_meta_select_post,
    'item_excerpt'      => $item_excerpt_post,
    'excerpt'           => $excerpt,
    /*---------------*/
    'item_thumbnail_list'   =>$item_thumbnail_post_list,
    'size_list'             => $size_list,
    'item_title_list'       =>$item_title_post_list,
    'item_meta_list'        =>$item_meta_post_list,
    'item_meta_select_list' =>$item_meta_select_post_list,
    'item_excerpt_list'     => $item_excerpt_post_list,
...
<div id="main-content" class="main-page-default">
    ...
    <div class="bzotech-container">
        <?php bzotech_get_template('top-filter','',array('style'=>$get_type,'number'=>$number,'show_number'=>$show_number,'show_type'=>$show_type,'column_style_type'=>$column_style_type),true); ?>
