...
if(empty($item_meta_select)) $item_meta_select = ['date','author','views','comments'];
                    ...
                    echo '<div class="content-single-blog">';
                        ...
                        <div class="content-post-default">
                            ...
                            if( ! empty( $post->post_title ) ){ ?>
                                 <h2 class="title30 font-title font-medium title-post-single color-title text-capitalize">
                                    <?php the_title()?>
                                    <?php echo (is_sticky()) ? '<i class="sticky-icon las la-star"></i>':''?>
                                </h2>
                            <?php } ?>
                            <?php 
                            if($check_meta == 'yes') bzotech_display_metabox('detail-post',$item_meta_select,'','meta-post-style1'); 
                            ?>  
                          
                            <?php bzotech_get_template_post( 'single-content/content',get_post_format(),$data,true );
                            ?>
                        ...
                        if($check_meta == 'yes') bzotech_display_metabox('tags-share','', '','meta-post-tags-share');
