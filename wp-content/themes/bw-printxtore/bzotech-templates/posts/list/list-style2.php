            ...
            <div class="post-info">
                <div class="post-info2">
                   <?php if($item_meta_list == 'yes') bzotech_display_metabox('detail-post',$item_meta_select_list,'','meta-post-style1');?>
                    <?php if($item_title_list == 'yes'):?><h3 class="title22 post-title font-medium font-title "><a class=" color-title" href="<?php echo esc_url(get_the_permalink()) ?>"><?php the_title()?> <?php echo (is_sticky()) ? '<i class="sticky-icon las la-star"></i>':''?></a></h3><?php endif?>
