...
if(empty($size)|| $size == 'custom') $size = array(460,307);
...
<?php echo '<div '.$item_inner.'>';?>
        ...
        <div class="post-info">
            ...
            <?php if($item_title == 'yes'):?><h3 class="title20 post-title font-semibold color-title"><a class="color-title" href="<?php echo esc_url(get_the_permalink()) ?>"><?php the_title()?></a></h3><?php endif ?>
