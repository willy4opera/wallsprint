...
$image_size = bzotech_get_size_image('100x67',$image_size); 
...
<div class="wg-post-list">
    ...
    if($post_query->have_posts()) { ?>
        <div class="elbzotech-wrapper-slider display-swiper-navi-style1 ">
            <div class="elbzotech-swiper-slider swiper-container slider-wrap" data-items-custom="" data-items="1" data-items-tablet="1" data-items-mobile="1" data-space="30"  data-space-tablet="30" data-space-mobile="30" data-column="<?php echo esc_attr($number_row)?>" data-auto="" data-center="" data-loop="" data-speed="" data-navigation="" data-pagination=""> 
                        ...
                        <div class="swiper-slide">
                            <div class="item-post-wg flex-wrapper">
                                ...
                                <div class="post-info">
                                    ...
                                    <?php the_title('<h3 class="title14 e-glo font-medium"><a class="color-gray line-height24" href="'.esc_url(get_the_permalink()).'">','</a></h3>')?>
                                </div>
                            </div>
                        </div>
                <?php }
