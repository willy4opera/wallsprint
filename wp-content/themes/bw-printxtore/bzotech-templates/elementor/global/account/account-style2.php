...
echo '<div class="button-account-e button-account-manager '.$settings['account_bt_class_css'].' ">';
	if($title_account && $settings['account_bttext_pos'] == 'before-icon' && $settings['account_bttext']) echo '<div class="title-account title16">'.$html_a.$title_account.'</a></div>'?>
	<?php 
	$icon_stt = '';
	...
	?>
	<?php if($title_account && $settings['account_bttext_pos'] == 'after-icon' && $settings['account_bttext']) echo '<div class="title-account title16">'.$html_a.$title_account.'</a></div>';
echo '</div>';