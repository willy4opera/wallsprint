...
<?php if($view !== 'slider-masory') echo '<div '.$item_wrap.'>';?>
	<?php if($view !== 'slider-masory') echo '<div '.$item_inner.'>';?>
		...
		<div class="product-info">
			...
			<?php endif?>
			<div class="product-extra-cart-price flex-wrapper flex_wrap-wrap align_items-center justify_content-space-between">
				<?php if($item_button == 'yes'):?>
					...
					if(!empty($button_icon['value'])){
						...
						$icon = '';
						$icon_after = '<i class="las la-arrow-right"></i>';
					}
