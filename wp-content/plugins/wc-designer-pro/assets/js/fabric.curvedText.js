		...
		_render: function (ctx){
			...
			if(this.letters){
				...
				if(this.effect==='curved'){
					...
					fixedLetterAngle=((parseInt(this.letters.item(0).fontSize)+space)/this.radius)/(Math.PI/180);
					textWidth=((this.text.length+1)*(parseInt(this.letters.item(0).fontSize)+space));
				}
				// Text align
