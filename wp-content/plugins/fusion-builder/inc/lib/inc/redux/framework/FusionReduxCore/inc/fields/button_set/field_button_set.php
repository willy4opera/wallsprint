...
// Don't duplicate me!
	if ( ! class_exists( 'FusionReduxFramework_button_set' ) ) {
		...
		class FusionReduxFramework_button_set {
			...
			public function enqueue() {
				...
				if (!wp_script_is ( 'fusionredux-field-button-set-js' )) {
					wp_enqueue_script(
						'fusionredux-field-button-set-js',
						FusionReduxFramework::$_url . 'inc/fields/button_set/field_button_set' . FusionRedux_Functions::isMin() . '.js',
						array( 'jquery', 'jquery-ui-core', 'fusionredux-js' ),
						time(),
						true
					);
				}
