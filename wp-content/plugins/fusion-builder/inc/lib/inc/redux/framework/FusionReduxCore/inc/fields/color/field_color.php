...
// Don't duplicate me!
if ( ! class_exists( 'FusionReduxFramework_color' ) ) {
	 ...
	 * @since       1.0.0
	 */
	class FusionReduxFramework_color {
		...
		public function render() {
			...
			echo '<input data-id="' . $this->field['id'] . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '" id="' . $this->field['id'] . '-color" class="fusionredux-color fusionredux-color-init ' . $this->field['class'] . '"  type="text" value="' . $this->value . '" data-oldcolor=""  data-default-color="' . ( isset( $this->field['default'] ) ? $this->field['default'] : "" ) . '" />';
		...
		public function enqueue() {
			...
			wp_enqueue_script(
				...
				FusionReduxFramework::$_url . 'inc/fields/color/field_color' . FusionRedux_Functions::isMin() . '.js',
