...
// Don't duplicate me!
if ( !class_exists ( 'FusionReduxFramework_divide' ) ) {

	/**
	 * Main FusionReduxFramework_divide class
	 *
	 * @since       1.0.0
	 */
	class FusionReduxFramework_divide {
		...
		public function enqueue() {
			if ($this->parent->args['dev_mode']) {
				wp_enqueue_style(
					'fusionredux-field-divide',
					FusionReduxFramework::$_url . 'inc/fields/divide/field_divide.css',
					array(),
					time(),
					'all'
				);
