...
class Fusion_Patcher_Admin_Screen {
	...
	public function form() {
		...
		<section class="avada-db-card avada-db-card-first avada-db-support-start">
			...
			printf( esc_html__( 'The %1$sPatcher%2$s allows you to apply small fixes to your site between Avada releases, thereby keeping your site up to date.' ), '<a href="https://avada.com/documentation/avada-patcher/" target="_blank" rel="noopener noreferrer">', '</a>' );
			?>
			</p>
		</section>
