...
class Fusion_Widget_Tweets extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p class="avada_style">
			<label for="<?php echo esc_attr( $this->get_field_id( 'consumer_key' ) ); ?>"><?php esc_html_e( 'Consumer Key:', 'Avada' ); ?></label>
		...
		<p class="avada_style">
			<label for="<?php echo esc_attr( $this->get_field_id( 'consumer_secret' ) ); ?>"><?php esc_html_e( 'Consumer Secret:', 'Avada' ); ?></label>
		...
		<p class="avada_style">
			<label for="<?php echo esc_attr( $this->get_field_id( 'access_token' ) ); ?>"><?php esc_html_e( 'Access Token:', 'Avada' ); ?></label>
		...
		<p class="avada_style">
			<label for="<?php echo esc_attr( $this->get_field_id( 'access_token_secret' ) ); ?>"><?php esc_html_e( 'Access Token Secret:', 'Avada' ); ?></label>
		...
		<p class="twitter_style">
			<label for="<?php echo esc_attr( $this->get_field_id( 'width' ) ); ?>"><?php esc_html_e( 'Max. Width (has to be between 180 and 520):', 'Avada' ); ?></label>
		...
		<p class="twitter_style">
			<label for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"><?php esc_html_e( 'Height (min. is 200):', 'Avada' ); ?></label>
		...
		<p class="twitter_style">
			<label for="<?php echo esc_attr( $this->get_field_id( 'theme' ) ); ?>"><?php esc_html_e( 'Color Scheme:', 'Avada' ); ?></label>
			<select id="<?php echo esc_attr( $this->get_field_id( 'theme' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'theme' ) ); ?>" class="widefat" style="width:100%;">
				<option value="light" <?php echo ( 'light' === $instance['theme'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Light', 'Avada' ); ?></option>
				<option value="dark" <?php echo ( 'dark' === $instance['theme'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Dark', 'Avada' ); ?></option>
			</select>
		</p>

		<p class="twitter_style">
			<label for="<?php echo esc_attr( $this->get_field_id( 'link_color' ) ); ?>"><?php esc_html_e( 'Link Color (leave empty for Theme default link color):', 'Avada' ); ?></label>
		...
		<p class="twitter_style">
			<label for="<?php echo esc_attr( $this->get_field_id( 'border_color' ) ); ?>"><?php esc_html_e( 'Border Color:', 'Avada' ); ?></label>
		...
		<p class="twitter_style">
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_header' ) ); ?>"><?php esc_html_e( 'Show Header', 'Avada' ); ?></label>
		</p>
		...
		<p class="twitter_style">
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_footer' ) ); ?>"><?php esc_html_e( 'Show Footer', 'Avada' ); ?></label>
		</p>
		...
		<p class="twitter_style">
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_borders' ) ); ?>"><?php esc_html_e( 'Show Borders', 'Avada' ); ?></label>
		</p>
		...
		<p class="twitter_style">
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'transparent_bg' ) ); ?>"><?php esc_html_e( 'Transparent Background', 'Avada' ); ?></label>
		</p>
		<?php
	}
	...
	public function render_new_widget( $widget_params ) {
		...
		?>
		<?php extract( $widget_params ); // phpcs:ignore WordPress.PHP.DontExtract.extract_extract ?>
		...
		<div style="overflow:hidden">
			...
			<?php else : ?>
				...
				<?php if ( $builder_status ) : ?>
					<?php /* translators: The twitter-ID. */ ?>
					<a class="twitter-timeline-backup" style="display: none" data-dnt="true" href="<?php echo esc_url_raw( 'https://twitter.com/' . $twitter_id ); ?>" data-widget-id="<?php echo esc_attr( $widget_id ); ?>"><?php printf( esc_attr__( 'Tweets by %s', 'Avada' ), esc_attr( $twitter_id ) ); ?></a>
				<?php endif; ?>
			<?php endif; ?>
	...
	public function render_old_widget( $widget_params ) {
		...
		extract( $widget_params ); // phpcs:ignore WordPress.PHP.DontExtract.extract_extract
		...
		if ( $tweets && is_array( $tweets ) ) {
			...
			if ( '' !== $icon_color ) {
				...
				echo 'color: ';
				echo esc_attr( Fusion_Sanitize::color( $icon_color ) );
				echo ';}';
				echo '</style>';
			}
	...
	public function ago( $time ) {
		...
		return sprintf( _x( '%s ago', '%s = human-readable time difference', 'Avada' ), human_time_diff( $time, current_time( 'timestamp' ) ) ); // phpcs:ignore WordPress.DateTime
	}
}
