...
class Fusion_Widget_Contact_Info extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'contact_info-widget', __( 'Avada: Contact Info', 'Avada' ), $widget_ops, $control_ops );
	...
	public function widget( $args, $instance ) {
		...
		<div class="contact-info-container">
			...
			<?php if ( ! empty( $instance['phone'] ) ) : ?>
				<p class="phone"><?php esc_html_e( 'Phone:', 'Avada' ); ?> <a href="tel:<?php echo esc_attr( $instance['phone'] ); ?>"><?php echo $instance['phone']; // phpcs:ignore WordPress.Security.EscapeOutput ?></a></p>
			<?php endif; ?>

			<?php if ( ! empty( $instance['mobile'] ) ) : ?>
				<p class="mobile"><?php esc_html_e( 'Mobile:', 'Avada' ); ?> <a href="tel:<?php echo esc_attr( $instance['mobile'] ); ?>"><?php echo $instance['mobile']; // phpcs:ignore WordPress.Security.EscapeOutput ?></a></p>
			<?php endif; ?>

			<?php if ( ! empty( $instance['fax'] ) ) : ?>
				<p class="fax"><?php esc_html_e( 'Fax:', 'Avada' ); ?> <a href="fax:<?php echo esc_attr( $instance['fax'] ); ?>"><?php echo $instance['fax']; // phpcs:ignore WordPress.Security.EscapeOutput ?></a></p>
			<?php endif; ?>

			<?php if ( ! empty( $instance['email'] ) ) : ?>
				<?php if ( apply_filters( 'fusion_disable_antispambot', false ) ) : ?>
					<p class="email"><?php esc_html_e( 'Email:', 'Avada' ); ?> <a href="mailto:<?php echo $instance['email']; // phpcs:ignore WordPress.Security.EscapeOutput ?>"><?php echo ! empty( $instance['emailtxt'] ) ? $instance['emailtxt'] : $instance['email']; ?></a></p>
				<?php else : ?>
					<p class="email"><?php esc_html_e( 'Email:', 'Avada' ); ?> <a href="mailto:<?php echo antispambot( $instance['email'] ); // phpcs:ignore WordPress.Security.EscapeOutput ?>"><?php echo ! empty( $instance['emailtxt'] ) ? $instance['emailtxt'] : $instance['email']; ?></a></p>
				<?php endif; ?>
			<?php endif; ?>

			<?php if ( ! empty( $instance['web'] ) ) : ?>
				<p class="web"><?php esc_html_e( 'Web:', 'Avada' ); ?> <a href="<?php echo esc_url_raw( $instance['web'] ); ?>"><?php echo ! empty( $instance['webtxt'] ) ? $instance['webtxt'] : $instance['web']; // phpcs:ignore WordPress.Security.EscapeOutput ?></a></p>
			<?php endif; ?>
		</div>
		<?php
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'address' ) ); ?>"><?php esc_html_e( 'Address:', 'Avada' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'phone' ) ); ?>"><?php esc_html_e( 'Phone:', 'Avada' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'mobile' ) ); ?>"><?php esc_html_e( 'Mobile:', 'Avada' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'fax' ) ); ?>"><?php esc_html_e( 'Fax:', 'Avada' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'email' ) ); ?>"><?php esc_html_e( 'Email:', 'Avada' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'emailtxt' ) ); ?>"><?php esc_html_e( 'Email Link Text:', 'Avada' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'web' ) ); ?>"><?php esc_html_e( 'Website URL (with HTTP(S)):', 'Avada' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'webtxt' ) ); ?>"><?php esc_html_e( 'Website URL Text:', 'Avada' ); ?></label>
