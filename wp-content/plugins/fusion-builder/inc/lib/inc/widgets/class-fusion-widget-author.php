...
class Fusion_Widget_Author extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		} elseif ( is_author() && isset( $queried_object->data->ID ) ) {
	...
	public function form( $instance ) {
		...
		?>
		<h4 style="line-height: 1.6em;"><?php esc_html_e( 'IMPORTANT: When used on single posts, the author will be auto pulled. If you want to display a specific author please use the "Custom Author" field. Post date will on be displayed on single posts.', 'Avada' ); ?></h4>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'custom_author' ) ); ?>"><?php esc_html_e( 'Custom Author (username or ID):', 'Avada' ); ?></label>
