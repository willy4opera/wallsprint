		...
		class Fusion_Views_Counter extends Fusion_Element {
			...
			public function get_inline_style() {
				...
				if ( $this->args['alignment_floated'] && 'floated' === $this->args['layout'] ) {
					$custom_css['alignment_floated'] = $this->args['alignment_floated'];
				}

				if ( $this->args['alignment_stacked'] && 'stacked' === $this->args['layout'] ) {
					$custom_css['alignment_stacked'] = $this->args['alignment_stacked'];
				}
				...
				return $this->get_css_vars_for_options( $css_vars_options ) . $this->get_custom_css_vars( $custom_css ) . $box_shadow;
			}
