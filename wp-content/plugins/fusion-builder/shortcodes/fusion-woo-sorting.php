		...
		class FusionSC_WooSorting extends Fusion_Element {
			...
			public function get_sorting_elements( $is_live = false ) {
				...
				if ( isset( $_SERVER['QUERY_STRING'] ) ) {
					$query_string = sanitize_text_field( urldecode( wp_unslash( $_SERVER['QUERY_STRING'] ) ) );
						...
						case 'count':
							...
							<ul class="sort-count order-dropdown">
								<li>
									...
									<ul>
										<li class="<?php echo ( $pc == $per_page ) ? 'current' : ''; // phpcs:ignore Universal.Operators.StrictComparisons ?>">
										...
										<li class="<?php echo ( $pc == $per_page * 2 ) ? 'current' : ''; // phpcs:ignore Universal.Operators.StrictComparisons ?>">
										...
										<li class="<?php echo ( $pc == $per_page * 3 ) ? 'current' : ''; // phpcs:ignore Universal.Operators.StrictComparisons ?>">
