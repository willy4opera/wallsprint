	...
	jQuery( document ).ready( function() {
		...
		FusionPageBuilder.fusion_text = FusionPageBuilder.ElementView.extend( {
			...
			getStyleVars: function( values ) {
				...
				cssVars.width            = { 'callback': _.fusionGetValueWithUnit };
				cssVars.min_width        = { 'callback': _.fusionGetValueWithUnit };
				cssVars.max_width        = { 'callback': _.fusionGetValueWithUnit };
				cssVars.width_medium     = { 'callback': _.fusionGetValueWithUnit };
				cssVars.min_width_medium = { 'callback': _.fusionGetValueWithUnit };
				cssVars.max_width_medium = { 'callback': _.fusionGetValueWithUnit };
				cssVars.width_small      = { 'callback': _.fusionGetValueWithUnit };
				cssVars.min_width_small  = { 'callback': _.fusionGetValueWithUnit };
				cssVars.max_width_small  = { 'callback': _.fusionGetValueWithUnit };
