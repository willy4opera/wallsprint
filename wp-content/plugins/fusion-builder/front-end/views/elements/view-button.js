	...
	jQuery( document ).ready( function() {
		...
		FusionPageBuilder.fusion_button = FusionPageBuilder.ElementView.extend( {
			...
			filterTemplateAtts: function( atts ) {
				...
				attributes.hoverIconAttr  = this.buildHoverIconAttr( atts.values );
				attributes.textAttr       = this.buildTextAttr( atts.values );
				attributes.hoverTextAttr  = this.buildHoverTextAttr( atts.values );
			...
			buildIconAttr: function( values ) {
				return this.getIconAttr( values );
			},

			/**
			 * Builds icon hover attributes.
			 *
			 * @since 3.12
			 * @param {Object} values - The values object.
			 * @return {Object}
			 */
			buildHoverIconAttr: function( values ) {
				return this.getIconAttr( values, 'hover' );
			},
			 ...
			 * @since 3.12
			 * @param {Object} values - The values object.
			 * @param {string} state - The button state.
			 * @return {Object}
			 */
			getIconAttr: function( values, state = 'default' ) {
				var icon = 'default' === state ? values.icon : values.hover_icon,
					buttonText = 'default' === state ? values.element_content : values.hover_text;
					buttonShortcodeIcon = {
						class: _.fusionFontAwesome( icon ),
						'aria-hidden': 'true'
					};

				buttonShortcodeIcon[ 'class' ] += ' awb-button__icon awb-button__icon--' + state;

				if ( '' === buttonText ) {
					buttonShortcodeIcon[ 'class' ] += ' awb-button__icon--no-margin';
				}
			...
			buildTextAttr: function( values ) {
				return this.getButtonTextAttr( values );
			},

			/**
			 * Builds hover text attributes.
			 *
			 * @since 3.12
			 * @param {Object} values - The values object.
			 * @return {Object}
			 */
			buildHoverTextAttr: function( values ) {
				return this.getButtonTextAttr( values, 'hover' );
			},

			/**
			 * Builds button text attributes.
			 *
			 * @since 3.12
			 * @param {Object} values - The values object.
			 * @param {string} state - The button state.
			 * @return {Object}
			 */	
			getButtonTextAttr: function( values, state = 'default' ) {
				var buttonTextAttr = {
					class: 'fusion-button-text'
				};

				buttonTextAttr[ 'class' ] += ' awb-button__text awb-button__text--' + state;
