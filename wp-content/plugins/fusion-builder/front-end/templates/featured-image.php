...
if ( 'undefined' !== typeof data.display_woo_out_of_stock && false !== data.display_woo_out_of_stock && 'undefined' !== typeof data.out_of_stock ) {
	wooBadges += data.out_of_stock;
}
if ( 'undefined' !== typeof data.display_woo_sale && false !== data.display_woo_sale && 'undefined' !== typeof data.sale ) {
	wooBadges += data.sale;
}
if ( '' !== wooBadges ) {
	output += '<div class="fusion-woo-badges-wrapper">' + wooBadges + '</div>';
}
...
if ( ( data.enable_rollover && 'yes' === data.display_rollover ) || 'force_yes' === data.display_rollover ) {
	...
	if ( 'product' === data.post_type ) {
		iconClass = ( inCart ) ? 'awb-icon-shopping-cart' : 'awb-icon-spinner';
