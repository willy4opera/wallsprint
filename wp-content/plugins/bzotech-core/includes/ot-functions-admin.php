...
if ( ! function_exists( 'ot_register_theme_options_page' ) ) {
  ...
  function ot_register_theme_options_page() {
    ...
    if ( function_exists( 'ot_register_settings' ) && OT_USE_THEME_OPTIONS ) {
      ...
      add_filter( 'option_page_capability_' . ot_options_id(), 'option_page_capability_fix', 999 );
...
if ( ! function_exists( 'option_page_capability_fix' ) ) {
  function option_page_capability_fix($caps){
    if(empty($caps)) $caps = apply_filters( 'ot_theme_options_capability', 'edit_theme_options' );
    return $caps;
  }
}
...
if ( ! function_exists( 'ot_register_settings_page' ) ) {
  ...
  function ot_register_settings_page() {
    ...
    $ot_register_pages_array =  array( 
      array( 
        'id'              => 'ot',
        'page_title'      => __( 'Option Advanced', 'option-tree' ),
        'menu_title'      => __( 'Option Advanced', 'option-tree' ),
