...
if(!class_exists('Bzotech_PluginsImporter'))
{
    class Bzotech_PluginsImporter
    {
        static $_dir;
        static $_url;
        static $_import_path;
        ...
        static function init()
        {
            ...
            if(isset($_REQUEST['bzotech_do_import']) and $_REQUEST['bzotech_do_import']){
                self::$_demo=$_REQUEST['bzotech_do_import'];
            }
        ...
        static function _add_import_js()
        {
            ...
            if($screen->base=='theme-options_page_svp_importer'){
        ...
        static function _add_sub_menu()
        {
            ...
            if(class_exists('Redux')) $id = '_options';
            add_submenu_page(
                $id,
                __('Import Demo Content','bzotech-core'),
                __('Import Demo Content','bzotech-core'),
                'manage_options',
                'svp_importer',
                array(__CLASS__,'_show_import_page')
            );
