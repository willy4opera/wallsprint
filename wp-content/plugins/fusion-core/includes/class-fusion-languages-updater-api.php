...
class Fusion_Languages_Updater_API {
	...
	public function __construct( $type = 'plugin', $slug = '', $ver = '', $lang = '' ) {
		...
		if ( ! FusionCore_Plugin::get_option( 'enable_language_updates' ) || '' === FusionCore_Plugin::get_option( 'enable_language_updates' ) || '0' === FusionCore_Plugin::get_option( 'enable_language_updates' ) ) {
			return;
		}
