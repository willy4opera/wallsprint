...
<div class="woocs_rates_shortcode">
    ...
    <?php if (!empty($currencies)): ?>
        <select class="woocs_rates_current_currency" data-precision="<?php echo intval($precision) ?>" data-exclude="<?php echo esc_attr($exclude_string); ?>">
            <?php
            if (!empty($currencies)) {
                        ...
                        <tbody id="woocs_list">
                            <?php foreach ($currencies as $key => $c) : ?>
                                ...
                                <tr>
                                    <td>                    
                                        <?php if (!empty($c['flag'])): ?>
                                            <img class="woocs_currency_rate_flag" src="<?php echo esc_attr($c['flag']) ?>" alt="<?php echo esc_attr($c['name']) ?>" />
                                        <?php endif; ?>
                                    </td>
                                    <td>
