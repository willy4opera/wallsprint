...
<p>
    ...
    <input class="widefat" type="text" id="<?php echo esc_attr($widget->get_field_id('exclude')); ?>" name="<?php echo esc_attr($widget->get_field_name('exclude')); ?>" value="<?php echo esc_attr($instance['exclude']); ?>" />
...
<p>
    ...
    <input class="widefat" type="text" id="<?php echo esc_attr($widget->get_field_id('precision')); ?>" name="<?php echo esc_attr($widget->get_field_name('precision')); ?>" value="<?php echo esc_attr($instance['precision']); ?>" />
