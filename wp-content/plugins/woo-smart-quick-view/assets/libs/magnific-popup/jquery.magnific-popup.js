    ...
    function (factory) {
        ...
        MagnificPopup.prototype = {
            ...
            _openClick: function (e, el, options) {
                var midClick = options.midClick !== undefined ?
                    options.midClick :
                ...
                var disableOn = options.disableOn !== undefined ?
                    options.disableOn :
        ...
        var INLINE_NS = 'inline',
            ...
            _putInlineElementsBack = function () {
                if (_lastInlineElement) {
                    _inlinePlaceholder.after(
                        _lastInlineElement.addClass(_hiddenClass)).detach();
        ...
        var hasMozTransform,
            getHasMozTransform = function () {
                if (hasMozTransform === undefined) {
                    hasMozTransform = document.createElement(
                        'p').style.MozTransform !== undefined;
                }
                        ...
                        if (mfp.items.length > 1 && gSt.arrows && !mfp.arrowLeft) {
                            var markup = gSt.arrowMarkup,
                                ...
                                arrowRight = mfp.arrowRight = $(
                                    markup.replace(/%title%/gi, gSt.tNext).replace(/%dir%/gi, 'right')).addClass(PREVENT_CLOSE_CLASS);
