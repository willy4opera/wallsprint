...
final class THEMECOMPLETE_EPO_ADMIN_BUILDER_Base {
	...
	public function settings_term_variations_image_helper( $value = '' ) {
		...
		echo '<span class="tm_upload_image tm_upload_imagep"><img class="tm_upload_image_img" alt="&nbsp;" src="' . esc_attr( $value ) . '" src="' . esc_attr( $value ) . '" /></span>';
	}
	...
	public function builder_sub_options( $args = [] ) {
		...
		foreach ( $options['title'] as $ar => $el ) {
			...
			if ( ! empty( $additional_currencies ) && is_array( $additional_currencies ) ) {
				...
				$o['price']['html_before_field']      = '<span class="tm-choice-currency">' . THEMECOMPLETE_EPO_HELPER()->wc_base_currency() . '</span><span class="tm-choice-regular">' . esc_html__( 'Price', 'woocommerce-tm-extra-product-options' ) . '</span>';
				$o['sale_price']['html_before_field'] = '<span class="tm-choice-currency">' . THEMECOMPLETE_EPO_HELPER()->wc_base_currency() . '</span><span class="tm-choice-sale">' . esc_html__( 'Sale Price', 'woocommerce-tm-extra-product-options' ) . '</span>';
				if ( empty( $return_js ) ) {
				...
				foreach ( $additional_currencies as $ckey => $currency ) {
					...
					$copy_value['html_before_field'] = '<span class="tm-choice-currency">' . $currency . '</span><span class="tm-choice-regular">' . esc_html__( 'Price', 'woocommerce-tm-extra-product-options' ) . '</span>';
					...
					$copy_value['html_before_field'] = '<span class="tm-choice-currency">' . $currency . '</span><span class="tm-choice-sale">' . esc_html__( 'Sale Price', 'woocommerce-tm-extra-product-options' ) . '</span>';
				...
				$o['price']['html_before_field']      = '<span class="tm-choice-regular">' . esc_html__( 'Price', 'woocommerce-tm-extra-product-options' ) . '</span>';
				$o['sale_price']['html_before_field'] = '<span class="tm-choice-sale">' . esc_html__( 'Sale Price', 'woocommerce-tm-extra-product-options' ) . '</span>';
				if ( empty( $return_js ) ) {
					THEMECOMPLETE_EPO_HTML()->create_field( $o['price'], 1 );
					THEMECOMPLETE_EPO_HTML()->create_field( $o['sale_price'], 1 );
				} else {
