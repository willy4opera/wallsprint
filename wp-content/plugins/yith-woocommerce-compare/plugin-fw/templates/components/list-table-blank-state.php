...
>
	...
	<?php if ( $cta && ! empty( $cta['title'] ) ) : ?>
		...
		$cta_data    = ! empty( $cta['data'] ) ? $cta['data'] : '';
		...
		<div class="yith-plugin-fw__list-table-blank-state__cta-wrapper">
			<a href="<?php echo esc_url( $cta_url ); ?>" class="<?php echo esc_attr( $cta_classes ); ?>" <?php echo yith_plugin_fw_html_data_to_string( $cta_data ); ?>>
