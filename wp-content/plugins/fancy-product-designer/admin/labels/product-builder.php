	...
	class FPD_Labels_Product_Builder {
		...
		public static function get_labels() {
			...
			return apply_filters('fpd_admin_labels_product_builder', array(
				...
				'colorLink3DLayer' => __( 'Color Link 3D Layer', 'radykal' ),
				'colorLink3DLayer_desc' => __( 'Enter the name of the 3D layer to link the color of the layer with a layer in the connected 3d model.', 'radykal' ),
