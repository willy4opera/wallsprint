...
if( !class_exists('FPD_AI_Service') ) {
	...
	class FPD_AI_Service {
        ...
        const SUPER_RES_ENDPOINT = 'ai/upscale';
        const REMOVE_BG_ENDPOINT = 'ai/remove_background';
        const TEXT2IMG_ENDPOINT = 'ai/text2image';
        ...
        public function __construct( $payload=array() ) {
            ...
            if( $payload['service'] == 'superRes' ) {
                ...
                $result = $this->send_json(
                    $this->get_service_url(self::SUPER_RES_ENDPOINT),
                    array(
            ...
            //remove background service
                ...
                $result = $this->send_json(
                    $this->get_service_url(self::REMOVE_BG_ENDPOINT),
                    array(
                        'image_url' => $payload['image'],
                    )
                );
            ...
            //remove background service
                ...
                $result = $this->send_json(
                    $this->get_service_url(self::TEXT2IMG_ENDPOINT),
                    array(
